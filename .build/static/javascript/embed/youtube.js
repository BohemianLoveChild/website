...
(function () {
    ...
    videojs.Youtube = videojs.MediaTechController.extend({
        ...
        init: function (player, options, ready) {
            ...
            this.startSeconds = NaN;
            if (player.options()['startSeconds'] !== 'undefined') {
                this.startSeconds = player.options()['startSeconds'];
            }
            ...
            if (this.player_.options()['ytcontrols']) {
                ...
                // Show the YouTube poster if there is no custom poster
                var poster = this.player_.poster();
                if (!poster || poster.indexOf('img.youtube.com/') > 0 || poster.indexOf('i.ytimg.com/') > 0) {
                    if (this.videoId == null) {
                        // Set the black background if there is no video initially
                        if (typeof this.iframeblocker !== 'undefined') {
            ...
            this.on('dispose', function () {
                ...
                // Remove the poster
                // MK: may not need to remove the poster. This causes a problem for the novideo tech
    ...
    videojs.Youtube.prototype.updateIframeSrc = function () {
        var params = {
            ...
            html5: (this.player_.options()['forceHTML5']) ? 1 : 1,
    ...
    videojs.Youtube.prototype.exitFullScreen = function (opt_callback) {

        this.startSeconds = this.ytplayer.getCurrentTime();
        ...
        VBX.Layout.reconfigVideoPlayer(currentDuration, this.startSeconds);
    ...
    videojs.Youtube.prototype.src = function (src) {
        if (typeof src !== 'undefined') {
            ...
            if (this.videoId !== null) {
                ...
                if (!isNaN(this.startSeconds) && this.startSeconds > 0)
                    videoInfo.startSeconds = this.startSeconds;

                if (this.player_.options()['autoplay'] && this.playVideoIsAllowed) {
                    this.ytplayer.loadVideoById(videoInfo);
                } else {
                    this.ytplayer.cueVideoById(videoInfo);
                }
    ...
    videojs.Youtube.prototype.play = function () {
        if (this.videoId !== null) {
            ...
            if (this.isReady_) {
                ...
                } catch (e) { } //try catch in order to resolve weird stack overflow bug
    ...
    videojs.Youtube.prototype.buffered = function () {
        if (this.ytplayer && this.ytplayer.getVideoLoadedFraction) {
            ...
            var secondsBuffered = this.ytplayer.getVideoLoadedFraction() * duration;
            return videojs.createTimeRange(0, secondsBuffered);
        } else {
            return videojs.createTimeRange(0, 0);
        }
    };

    videojs.Youtube.prototype.played = function () {
        if (this.ytplayer && this.ytplayer.getCurrentTime) {
            var currentTime = this.ytplayer.getCurrentTime();
            return videojs.createTimeRange(0, currentTime);
        } else {
            return videojs.createTimeRange(0, 0);
        }
    };
    ...
    videojs.Youtube.prototype.isFullscreen = function () {
        var doc = document;
        ...
        return !!(doc.webkitIsFullScreen || doc.mozFullScreen ||
            ...
            (this.playerEl_ != null && this.playerEl_.webkitDisplayingFullscreen));
    };
    ...
    videojs.Youtube.prototype.onReady = function () {
        ...
        var poster = this.player_.poster();
        if (poster.indexOf('img.youtube.com/') > 0 || poster.indexOf('i.ytimg.com/') > 0) {
            this.player_.poster(' ');
            this.addClass(this.playerEl_, 'has-youtube-poster');
            if (typeof this.iframeblocker !== 'undefined') {
                this.iframeblocker.style.display = 'none';
            }
        } else {
            this.removeClass(this.playerEl_, 'has-youtube-poster');
            if (typeof this.iframeblocker !== 'undefined') {
        ...
        if (!isNaN(this.startSeconds) && this.startSeconds > 0) {
            this.ytplayer.seekTo(this.startSeconds, true);
        }
    };

    videojs.Youtube.prototype.startSeconds = NaN;
    ...
    videojs.Youtube.prototype.setAutoplay = function (autoplay) {
     ...
     * @private
     */
    videojs.Youtube.prototype.addClass = function (element, classToAdd) {
        if ((' ' + element.className + ' ').indexOf(' ' + classToAdd + ' ') == -1) {
            element.className = element.className === '' ? classToAdd : element.className + ' ' + classToAdd;
        }
    };
     ...
     * @private
     */
    videojs.Youtube.prototype.removeClass = function (element, classToRemove) {
        var classNames, i;
    ...
    var def = ' ' +
      '.vjs-youtube .vjs-poster { background-size: contain; }' +
